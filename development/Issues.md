...
1. Authorization issue in submissions
   [submission.go (line 35)](/Users/harsh.g/Documents/GitHub/Algoforces-backend/internal/handlers/submission.go:35) accepts user_id from request body. A user can submit as another user. Take user ID from JWT context instead.
...
3. Role naming mismatch
   Some routes use problem-setter, others use problem_setter.
   ...
   Domain validation uses problem_setter, so contest routes may fail for problem setters.
