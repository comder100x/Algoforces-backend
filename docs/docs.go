...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/contest-problem/bulk": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Bulk Create Contest Problems Request",
                        "name": "bulkCreateRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.BulkCreateContestProblemRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/domain.BulkCreateContestProblemResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/contest-problem/contest/{contestId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.GetContestProblemsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/contest-problem/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Contest Problem Request",
                        "name": "createContestProblemRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreateContestProblemRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/domain.CreateContestProblemResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/contest-problem/update": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Update Contest Problem Request",
                        "name": "updateContestProblemRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateContestProblemRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateContestProblemResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/contest-problem/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Contest Problem ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.GetContestProblemResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.DeleteContestProblemResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.BulkCreateContestProblemRequest": {
            "type": "object",
            "required": [
                "contest_id",
                "problems"
            ...
            "properties": {
                ...
                "problems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.BulkContestProblemItem"
                    }
                }
            }
        },
        "domain.BulkCreateContestProblemResponse": {
            "type": "object",
            "properties": {
                "created_problems": {
                    "type": "array",
        ...
        "domain.ContestProblemDetail": {
            ...
            "properties": {
                ...
                "problem": {
                    "description": "Optional: include problem details",
                    "allOf": [
                        {
        ...
        "domain.CreateContestProblemRequest": {
            "type": "object",
            "required": [
                "contest_id",
                "max_points",
        ...
        "domain.CreateContestProblemResponse": {
            "type": "object",
            "properties": {
                "contest_id": {
                    "type": "string"
        ...
        "domain.DeleteContestProblemResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "domain.GetContestProblemResponse": {
            "type": "object",
            "properties": {
                "contest_id": {
                    "type": "string"
        ...
        "domain.GetContestProblemsResponse": {
            "type": "object",
            "properties": {
                "problems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ContestProblemDetail"
                    }
                }
            }
        },
        ...
        "domain.UpdateContestProblemRequest": {
            "type": "object",
            "required": [
                "unique_id"
            ],
        ...
        "domain.UpdateContestProblemResponse": {
            "type": "object",
            "properties": {
                "contest_id": {
                    "type": "string"
